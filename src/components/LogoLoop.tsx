  ...
  ({
    ...
    const logoLists = useMemo(
      () =>
        Array.from({ length: copyCount }, (_, copyIndex) => (
          <ul
            className={cx("flex items-center overflow-visible hover:scale-100", isVertical && "flex-col")}
            key={`copy-${copyIndex}`}
            role="list"
    ...
    return (
      <div ref={containerRef} className={rootClasses} style={containerStyle} role="region" aria-label={ariaLabel}>
        ...
        <div
          className={cx(
            "flex will-change-transform select-none relative z-0 overflow-visible",
